...
class ChangePasswordUi(object):
    def setupUi(self, MainWindow):
        ...
        self.label_4.setGraphicsEffect(
            QtWidgets.QGraphicsDropShadowEffect(blurRadius=25, xOffset=0, yOffset=0))
        self.accept_btn.setGraphicsEffect(
            QtWidgets.QGraphicsDropShadowEffect(blurRadius=25, xOffset=0, yOffset=0))
        self.accept_btn.setGraphicsEffect(
            QtWidgets.QGraphicsDropShadowEffect(blurRadius=25, xOffset=0, yOffset=0))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_4.setText(_translate(
            "MainWindow", "<html><head/><body><p><span style=\" font-size:16pt;\">Cambiar</span></p><p><span style=\" font-size:16pt;\">Contraseña</span></p></body></html>"))
        self.new_password_imp.setPlaceholderText(
