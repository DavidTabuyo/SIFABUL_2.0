...
class AdminUi(object):
    def setupUi(self, MainWindow):
        ...
        self.workers_layout.setSizeConstraint(
        ...
        self.notifications_layout = QtWidgets.QVBoxLayout(
        ...
        self.send_notification_btn.setCursor(
            QtGui.QCursor(QtCore.Qt.PointingHandCursor))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.edit_list_btn.setText(_translate(
            "MainWindow", "Editar trabajadores"))
        self.close_btn.setText(_translate("MainWindow", "CERRAR SESION"))
        self.label_12.setText(_translate("MainWindow", "Opciones"))
        self.send_notification_btn.setText(
            _translate("MainWindow", "Enviar notificacion"))
